...
namespace _Client_.Scripts.Runtime.Utils
{
    ...
    {
        private static StringBuilder stringBuilder = new StringBuilder(8);
        
        public static Color R(this Color color, float r) { return new Color(r, color.g, color.b, color.a); }

        public static Color G(this Color color, float g) { return new Color(color.r, g, color.b, color.a); }

        public static Color B(this Color color, float b) { return new Color(color.r, color.g, b, color.a); }

        public static Color A(this Color color, float a) { return new Color(color.r, color.g, color.b, a); }
        ...
        public static string ToHexNoAlpha(this Color32 color)
        {
